...
2. **Add this repo as a file source:**
   - Settings → File manager → Add source → type this exact path:
     `https://fireblazingtv.github.io/FireBlazingTV/repo/zips/`
   - Name it e.g. `FireBlazingTV`.
   - (This uses GitHub Pages rather than raw.githubusercontent.com, because raw GitHub URLs can't be browsed as folders — GitHub Pages can.)
